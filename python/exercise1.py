...
lati = COLOR(Color4f([0.5,0.5,0.5,1.0]))(STRUCT([lati1,lati2,T(1)(17)(lati1), T(1)(25)(lati2)]))
...
ingresso = COLOR(Color4f([0.5,0.5,0.5,1.0]))(STRUCT([ingresso1,ingresso2]))
...
latoOvest = COLOR(Color4f([0.5,0.5,0.5,1.0]))(STRUCT([latoOvest1,latoOvest2]))
...
latoSud = COLOR(Color4f([0.5,0.5,0.5,1.0]))(STRUCT([latoSud1,latoSud2]))
...
latoNord = COLOR(Color4f([0.5,0.5,0.5,1.0]))(STRUCT([latoNord1,latoNord2]))
...
latoEst = COLOR(Color4f([0.5,0.5,0.5,1.0]))(STRUCT([latoEst1,latoEst2,T(2)(5)(latoEst1)]))
